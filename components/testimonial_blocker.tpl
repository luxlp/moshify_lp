<section class="block">
    <header class="block__header">
        <h2>What our Custoemrs are Saying</h2>
        <p>
        ...
        <div class="card testimonial">
            <div class="grid grid--1x2">
                ...
                <blockquote class="quote">
                    <p class="quote__text">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam non cum debitis, nemo repellat reiciendis est quae officia deserunt sint.
                    </p>
                    <footer>
                        <div class="media">
                            ...
                            <div class="media__body">
                                ...
                                <p class="quote_organization">ABC Company</p>
                            </div>
                        </div>
                    </footer>
                </blockquote>
